...
Route::any('/categories', [AdminController::class, 'categories'])->name('categories')->middleware('auth', 'active');
Route::any('/new_category', [AdminController::class, 'new_category'])->name('category.new')->middleware('auth', 'active');
Route::any('/edit_category/{category}', [AdminController::class, 'edit_category'])->name('category.edit')->middleware('auth', 'active');
