        ...
        <div class="row">
            ...
            <div class="col-md-6">
                    <div class="mb-3">
                        ...
                        <textarea form="post_form" id="textarea1" class="form-control" name="body" rows="30" cols="30" required>{!! $post->body !!}</textarea>
                    </div>
                
                    <button form="post_form" class="btn btn-primary mb-3" type="submit">Αποθήκευση</button>
                </form>
            </div>
        </div>
